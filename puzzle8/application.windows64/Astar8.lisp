...
(defun executeSearch ()
    ...
    (setq abierto (list (list 0 nil 0 0 -1 edoInicial)) cerrado '() solucion '() movs '((1 0)(-1 0)(0 1)(0 -1)) id 0 limIt 25000 limEx 25000)
    ...
    (write-non-empty-list-to-a-file "output.txt" solucion)
)
...
(defun get-input ()
    (setq str (get-file "input.txt"))
    (setq edoIn (from-string-to-list (car str)) edoFin (from-string-to-list (cadr str))))
